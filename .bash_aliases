...
alias usdbrl='curl "http://free.currencyconverterapi.com/api/v5/convert?q=USD_BRL&compact=y" 2>&1 | regextract "\:(\d[^}]+)}" | e R\$ $(cat -)'
...
# alias tts='e ; xargs -I{} printf "(SayText \"{}\")" | festival -i'
