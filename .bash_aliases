...
# config this
alias cfa='sudoedit $HOME/.bash_aliases'
# config dotfiles
alias cfd='sudoedit $HOME/disk/gdrive/Programming/bash/dotfiles/grab_updated_and_push.sh'
# config push
...
alias vzsh='sudoedit $HOME/.zshrc'
